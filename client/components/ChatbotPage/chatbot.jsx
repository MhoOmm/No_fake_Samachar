  ...
  const handleAnalyze = async () => {
    ...
    try {
      if (mode === "ai") {
        ...
        const res = await fetch("https://no-fake-samacharbackend.onrender.com/api/chatbot/analyze/hf", {
          method: "POST",
        ...
        // Call Fake News API
        const res = await fetch("https://no-fake-samacharbackend.onrender.com/api/chatbot/analyze/second", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ text: input }),
        });
